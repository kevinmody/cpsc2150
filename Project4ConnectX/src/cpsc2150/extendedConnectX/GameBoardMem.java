...
import java.util.Map;
    ...
    public class GameBoardMem extends cpsc2150.extendedConnectX.AbsGameBoard {
        Map<Character, List<cpsc2150.extendedConnectX.BoardPosition>> mapBoard = new HashMap<Character, List<cpsc2150.extendedConnectX.BoardPosition>>();
        int maxRow;
        int maxCol;
        int numToWin;
        ...
        public char whatsAtPos(cpsc2150.extendedConnectX.BoardPosition pos) {
            for (Map.Entry<Character, List<cpsc2150.extendedConnectX.BoardPosition>> map : mapBoard.entrySet()) {
         ...
         */
        @Override
        public boolean isPlayerAtPos(cpsc2150.extendedConnectX.BoardPosition pos, char player){
